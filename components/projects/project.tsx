...
const Project = ({ project }: props): JSX.Element => {
  return (
    <div className="w-full flex flex-col md:flex-row justify-center items-center px-8 lg:px-0">
      <div className="w-10/12 sm:w-3/4 xl:w-7/12 2xl:5/12 h-full ml-0 lg:ml-20 mb-6 lg:mb-0 p-4 2xl:p-32" data-aos="fade-right">
        <img
      ...
      <div className="w-1 h-80 bg-orange-dark shadow-red-thicker hidden md:flex mr-14 lg:mr-20" data-aos="fade"></div>
      <div className="w-full flex flex-col justify-center items-center lg:items-start ml-0 xl:ml-28 mr-0 lg:mr-20" data-aos="fade-left">
